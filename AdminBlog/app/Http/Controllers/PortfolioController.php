...
class PortfolioController extends Controller
{
    ...
    function addProfilepicture(Request $request){
        ...
        DB::table('portfolio_photo')->insert(['photo' => $photo]);
    }
    ...
    function updateContact(Request $request)
    {
        ...
        return DB::table('portfolio_emergency_contact')->where('id', '=', $id)->update(['contactStatus' => $contactStatus, 'contactInformation' => $contactInformation]);
    ...
    function addContact(Request $request)
    {
        $contactStatus = $request->input('contactStatus');
        $contactInformation = $request->input('contactInformation');
        return DB::table('portfolio_emergency_contact')->insert(['contactStatus' => $contactStatus, 'contactInformation' => $contactInformation]);
    ...
    function addObjectives(Request $request){
        return DB::table('career_objectives')->insert(['objectives' => $request->objectivesId]);
