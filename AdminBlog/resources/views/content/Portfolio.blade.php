...
@section('content')
    ...
    <table id="myTable" class="table-bordered">
        <h6 class="p-3"><a id="addProfilePhoto" class="btn btn-outline-deep-purple">ADD PHOTO</a></h6>
        <thead>
        <th>PHOTO</th>
        <th>ACTION</th>
        </thead>
    ...
    <div class="modal fade" id="addProfilePictureModal" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalLabel"
         aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <h1 id="editId" class="d-none"></h1>
                <div class="modal-body">
                    <h1 id="addProfilePictureModal" class="p-3 d-none"></h1>
                    <div id="header" class="mb-2"></div>

                    <input type="file" id="addProfilePictureID" class="form-control mb-4" required/>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Close</button>
                    <button id="addProfilePictureModalButton" type="button" class="btn btn-primary btn-sm">
                        Save
                    </button>
                </div>
            </div>
    ...
    {{----------------------------------------------CAREER OBJECTIVES---------------------------------------------}}
    <table id="myTable" class="table-bordered ">
        <h6 class="p-3"><a id="addObjectiveButton" class="btn btn-outline-deep-purple">ADD OBJECTIVES</a></h6>
    ...
    {{--add Objectives--}}
    <div class="modal fade" id="addObjectives" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header text-center">
                ...
                <h1 id="editId"></h1>
                <div class="modal-body">
                    <h1 id="addObjectiveStatus" class="p-3 d-none"></h1>
                    <div id="header" class="mb-2"></div>
                    <textarea type="text" style="min-height: 200px;" id="addObjectivesID" class="form-control mb-4"
                              placeholder="Type your career objectives here..." required></textarea>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Close</button>
                    <button id="addObjectiveModalButton" type="button" class="btn btn-primary btn-sm">Save</button>
                </div>
            </div>
        </div>
    </div>
